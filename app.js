            ...
            card.innerHTML = `
                <div class="app-body">
                    ...
                    <div class="app-actions">
                        ...
                        ${item.releaseUrl ? `
                            <a href="${item.releaseUrl}" target="_blank" rel="noopener noreferrer" class="btn btn-release" title="View Release">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2l2.4 7.4H22l-6 4.6 2.3 7.4-6.3-4.6L5.7 21.4 8 14 2 9.4h7.6z"/></svg>
                                <span>Release</span>
                            </a>
                        ` : ''}
                        ${item.githubUrl ? `
